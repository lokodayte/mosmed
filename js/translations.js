const translations = {
  ...
  hero_body: {
    ...
    ru: "MOSMED — ведущий стратегический партнёр и дистрибьютор передовых роботических технологий в медицине. Мы обеспечиваем полный цикл клинической интеграции с хирургическим обучением и прокторингом мирового уровня.",
  ...
  about_p1: {
    ...
    ru: "Основанная семьёй Мосоян в 2025 году, MOSMED — это ереванская компания, специализирующаяся на интеграции передовых медицинских технологий, в частности медицинской робототехники.",
  ...
  about_h2: {
    en: "Robotic surgery distributor in Armenia",
    ru: "Дистрибьютор роботической хирургии в Армении",
    am: "Ռոբոտային վիրաբուժության բաշխող Հայաստանում",
  },
  about_h3: {
    en: "Clinical integration support",
    ru: "Полный цикл клинической интеграции",
    am: "Կլինիկական ինտեգրման լրիվ աջակցություն",
  },
  ...
  expertise_card1_body: {
    ...
    ru: "Надёжные партнёры по внедрению современных многопортовых роботических систем в ведущие государственные и частные больницы. Мы берём на себя всё — от соответствия нормативным требованиям до логистики и монтажа.",
  ...
  why_card3_heading: {
    ...
    ru: "Акцент на передовые и роботические технологии",
  ...
  gallery_cap2: {
    en: "Professor Mkrtich Mosoian performing the first robot-assisted prostatectomy in Armenia",
    ru: "Профессор Мкртич Мосоян выполняет первую роботическую простатэктомию в Армении",
    am: "Պրոֆեսոր Մկրտիչ Մոսոյանը կատարում է Հայաստանում ռոբոտի օժանդակությամբ առաջին պրոստատէկտոմիան",
  },
  gallery_cap3: {
  ...
  gallery_cap5: {
    en: "Professor Mkrtich Mosoian leading a robotic surgery proctoring session in Yerevan",
    ru: "Профессор Мкртич Мосоян проводит сессию прокторинга по роботической хирургии в Ереване",
    am: "Պրոֆեսոր Մկրտիչ Մոսոյանը ղեկավարում է ռոբոտային վիրաբուժության պրոկտորինգի նիստը Երևանում",
  },
  ...
  contact_address: {
    en: "Nalbandyan St, Building 50, Apt. 26\nYerevan, Armenia",
    ru: "ул. Налбандяна, д. 50, кв. 26\nЕреван, Армения",
    am: "Նալբանդյան փ., Շ. 50, Բն. 26\nԵրևան, Հայաստան",
  },
  contact_phone_label: {
    en: "Telephone",
    ru: "Телефон",
  ...
  press_article1_title: {
    ...
    ru: "В Армении проведена первая роботическая операция",
  ...
  footer_copyright: {
    en: "© {year} MOSMED. All rights reserved.",
    ru: "© {year} MOSMED. Все права защищены.",
  ...
  map_title: {
    ...
    ru: "Местоположение офиса MOSMED",
    am: "MOSMED-ի գրասենյակի գտնվելու վայրը",
  },
};
